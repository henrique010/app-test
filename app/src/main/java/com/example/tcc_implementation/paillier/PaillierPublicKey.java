 ...
 */
package com.example.tcc_implementation.paillier;

import java.math.BigInteger;

import static com.example.tcc_implementation.util.BigIntegerUtil.randomPositiveNumber;

import com.example.tcc_implementation.paillier.util.BigIntegerUtil;
